...
lock = PhotoImage(file = r"100DaysOfCode\\pass-manager\\logo.png")
canvas.create_image(150,150, image = lock)
canvas.pack()

l1 = Label(root, text="Website", font=("Times New Roman", "13" ,"bold"), bg="white")
l1.place(x=50,y=300)

search_button = Button(text = "Search",  width= 7, font=("Times New Roman", "13" ,"normal"), command = search)
search_button.place(x = 330, y = 299)

e1 = Entry(root, width=30)
e1.place(x=140, y = 300)

l2 = Label(root, text="E-mail", font=("Times New Roman", "13" ,"bold"), bg="white")
l2.place(x=50, y = 330)

e2 = Entry(root, width=30, textvariable=EMAIL)
e2.place(x=140, y = 330)

l3 = Label(root, text = "Password", font=("Times New Roman", "13" ,"bold"), bg="white")
l3.place(x=50, y = 360)
...
b2 = Button(text = "SAVE",  width= 30, font=("Times New Roman", "13" ,"bold"), command = safe)
